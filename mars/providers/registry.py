...
Usage
-----
    from mars.providers import get_provider, list_providers
...
---------------------
1. Create ``mars/providers/<name>.py`` with a class subclassing
