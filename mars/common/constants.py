...
# https://a2a-protocol.org — peer agent HTTP+JSON-RPC 2.0 standard.
# A2A complements MCP: MCP = agent↔tool (stdio), A2A = agent↔agent (HTTP).

A2A_CARD_PATH            = "/.well-known/agent.json"
A2A_METHOD_SEND          = "message/send"
A2A_METHOD_GET           = "tasks/get"
A2A_METHOD_CANCEL        = "tasks/cancel"
A2A_TASK_STATE_SUBMITTED = "submitted"
A2A_TASK_STATE_WORKING   = "working"
A2A_TASK_STATE_COMPLETED = "completed"
A2A_TASK_STATE_FAILED    = "failed"
A2A_TASK_STATE_CANCELED  = "canceled"
A2A_TIMEOUT              = 30.0  # seconds to wait for an A2A message/send response
