...
- CopilotProvider: raises when no token, passes correct headers
"""
...
from mars.client.providers.copilot import _get_token
...
class TestCopilotProviderConstruction:
    def test_raises_when_no_token(self) -> None:
        with mock.patch("mars.client.providers.copilot._get_token", return_value=None), \
    ...
    def test_constructs_via_gh_auth_token(self) -> None:
        with mock.patch("mars.client.providers.copilot._get_token", return_value="gho_from_gh"), \
             mock.patch("openai.AsyncOpenAI"):
            from mars.client.providers.copilot import CopilotProvider
            p = CopilotProvider()
