"""Unit tests for mars.client.providers.ollama.

Covers:
- _supports_tools: model name matching
- OllamaProvider.__init__: base_url construction, default model
- OllamaProvider.list_models: graceful fallback when Ollama not running
"""
...
from mars.client.providers.ollama import OllamaProvider, _supports_tools
