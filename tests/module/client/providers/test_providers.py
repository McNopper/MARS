...
from mars.client.providers.base import LLMMessage, LLMResponse, ModelInfo, ToolSpec
from mars.client.providers.mock import MockProvider
from mars.client.providers.registry import get_provider, list_providers
...
class TestMockProvider:
    ...
    async def test_complete_returns_fixed_response(self):
        p = MockProvider(response="test reply", delay=0.0)
...
class TestProviderRegistry:
    ...
    def test_unknown_provider_raises(self):
        with pytest.raises((KeyError, ValueError)):
            get_provider("does-not-exist-xyz")
